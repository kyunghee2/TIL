...
```
![django_sqlite2](C:\TIL\md_img\django_sqlite2.JPG)
...
```
- models.py 수정후 makemigrations 하면 새로운 migrations 생성됨
```cmd
$ python manage.py makemigrations
```

- Extensions > SQLite 설치
![django_sqlite4](C:\TIL\md_img\django_sqlite3.JPG)

- ctrl + shift+ p >  sqlite : Open Databse > 
- 어플리케이션 내에 sqlite 선택
![django_sqlite4](C:\TIL\md_img\django_sqlite4.jpg)
```cmd
student@M150119 MINGW64 /c/TIL/05_django/02_django_orm_crud (master)
...
```
![django_sqlite5](C:\TIL\md_img\django_sqlite5.jpg)
